...
//@EFBO: PayPalCheckoutActivityClass hasInteractionWith client-agent
public class PayPalCheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //@EFBO: "Display Pay with PayPal Screen" hasInterface PayPalCheckoutActivityClass
        ...
        //@EFBO: PayPalCheckoutActivityClass hasElement payPalButton
        //@EFBO: payPalButton isInterfaceOf "Click PAY WITH PAYPAL Button"
        Button payPalButton = (Button)findViewById(R.id.pay_pal_button);
        assert payPalButton != null;
        //@EFBO: payPalButton hasInteractionWith user-agent
    ...
    //@EFBO: "Click PAY WITH PAYPAL Button" hasNextEvent "Send Payment Verification to Server"
    //@EFBO: PayPalCheckoutActivityClass isInterfaceOf "Send Payment Verification to Server"
            ...
            public void onResponse(ServerObject response) {
                try {
                    ...
                    if(!TextUtils.isEmpty(response.getSuccess())){
                        //@EFBO: PayPalCheckoutActivityClass isInterfaceOf "Receive Successful Payment Message from Server"
                    ...
                    //@EFBO: "Receive Failed Payment Message from Server" isAlternateEventOf "Receive Successful Payment Message from Server"
                        {
                            //@EFBO: PayPalCheckoutActivityClass isInterfaceOf "Receive Failed Payment Message from Server"
